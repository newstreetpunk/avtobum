 ...
 *
 */
function(e,t){"object"==typeof exports?module.exports=t(e):"function"==typeof define&&define.amd?define([],t):e.LazyLoad=t(e)}("undefined"!=typeof global?global:this.window||this.global,(function(e){"use strict";"function"==typeof define&&define.amd&&(e=window);const t={src:"data-src",srcset:"data-srcset",srcbefore:"data-srcbefore",lazynowclass:"data-lazynowclass",selector:".lazyload",selectorparent:".lazyparent",root:null,rootMargin:"0px",threshold:0},n=function(){let e={},t=!1,i=0,o=arguments.length;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(t=arguments[0],i++);let r=function(i){for(let o in i)Object.prototype.hasOwnProperty.call(i,o)&&(t&&"[object Object]"===Object.prototype.toString.call(i[o])?e[o]=n(!0,e[o],i[o]):e[o]=i[o])};for(;i<o;i++){r(arguments[i])}return e};function i(e,i){this.settings=n(t,i||{}),this.images=e||document.querySelectorAll(this.settings.selector),this.observer=null,this.init()}if(i.prototype={init:function(){if(!e.IntersectionObserver)return void this.loadImages();let t=this,n={root:this.settings.root,rootMargin:this.settings.rootMargin,threshold:[this.settings.threshold]};this.observer=new IntersectionObserver((function(e){Array.prototype.forEach.call(e,(function(e){if(e.isIntersecting){t.observer.unobserve(e.target);let n=e.target.getAttribute(t.settings.src),i=e.target.getAttribute(t.settings.srcset),o=e.target.getAttribute(t.settings.srcbefore),r=e.target.getAttribute(t.settings.lazynowclass),s=!1;"img"===e.target.tagName.toLowerCase()?(e.target.onload=function(){e.target.classList.remove(t.settings.selector.split(".").join("")),e.target.parentNode.classList.remove(t.settings.selectorparent.split(".").join(""))},n&&(e.target.src=n),i&&(e.target.srcset=i)):null!==o?(e.target.pseudoStyle("before","background-image","url("+o+")"),s=!0):null!==r?(e.target.classList.add(r),s=!0):(e.target.style.backgroundImage="url("+n+")",s=!0),s&&(e.target.classList.remove(t.settings.selector.split(".").join("")),e.target.parentNode.classList.remove(t.settings.selectorparent.split(".").join("")))}}))}),n),Array.prototype.forEach.call(this.images,(function(e){t.observer.observe(e)}))},loadAndDestroy:function(){this.settings&&(this.loadImages(),this.destroy())},loadImages:function(){if(!this.settings)return;let e=this;Array.prototype.forEach.call(this.images,(function(t){let n=t.getAttribute(e.settings.src),i=t.getAttribute(e.settings.srcset),o=t.getAttribute(e.settings.srcbefore),r=t.getAttribute(e.settings.lazynowclass),s=!1;"img"===t.tagName.toLowerCase()?(t.onload=function(){t.classList.remove(e.settings.selector.split(".").join("")),entry.target.parentNode.classList.remove(e.settings.selectorparent.split(".").join(""))},n&&(t.src=n),i&&(t.srcset=i)):null!==o?(t.pseudoStyle("before","background-image","url("+o+")"),s=!0):null!==r?(t.classList.add(r),s=!0):(t.style.backgroundImage="url('"+n+"')",s=!0),s&&(t.classList.remove(e.settings.selector.split(".").join("")),t.parentNode.classList.remove(e.settings.selectorparent.split(".").join("")))}))},destroy:function(){this.settings&&(this.observer.disconnect(),this.settings=null)}},e.lazyload=function(e,t){return new i(e,t)},e.jQuery){const t=e.jQuery;t.fn.lazyload=function(e){return(e=e||{}).attribute=e.attribute||"data-src",new i(t.makeArray(this),e),this}}return i})),$((function(){function e(e){var t,n=e.querySelector("thead"),i=e.querySelector("tbody");function o(){var e=[].slice.call(n.querySelectorAll("th")),t=[].slice.call(i.querySelectorAll("tr"));i.setAttribute("style",""),n.style.width="",n.style.position="",n.style.top="",n.style.left="",n.style.zIndex="",e.forEach((function(e){e.style.display="",e.style.width="",e.style.position="",e.style.top="",e.style.left=""})),t.forEach((function(e){e.setAttribute("style","")})),[].slice.call(i.querySelectorAll("td")).forEach((function(e){e.style.width="",e.style.position="",e.style.left=""}));var o=e.map((function(e){var t=e.getBoundingClientRect(),n=document.defaultView.getComputedStyle(e,"");return{boundingWidth:t.width,boundingHeight:t.height,width:parseInt(n.width,10),paddingLeft:parseInt(n.paddingLeft,10)}})),r=o.reduce((function(e,t){return e+t.boundingWidth}),0);i.style.display="block",i.style.width=r+"px",n.style.width=r-o[0].boundingWidth+"px",n.style.position="absolute",n.style.top="0",n.style.left=o[0].boundingWidth+"px",n.style.zIndex=10,e.forEach((function(e,t){e.style.minWidth=o[t].width+"px",e.style.width=o[t].width+"px",0===t&&(e.style.position="absolute",e.style.top="0",e.style.left=-o[0].boundingWidth+"px")})),i.style.marginTop=o[0].boundingHeight+"px",t.forEach((function(e,t){e.style.display="block",e.style.paddingLeft=o[0].boundingWidth+"px",[].slice.call(e.querySelectorAll("td")).forEach((function(e,t){e.style.minWidth=o[t].width+"px",e.style.width=o[t].width+"px",0===t&&(e.style.position="absolute",e.style.left="0")}))}))}return e.style.overflow="auto",e.style.position="relative",o(),window.addEventListener("resize",(function(){t||(t=setTimeout((function(){t=null,o()}),500))}),!1),e.addEventListener("scroll",(function(){n.style.transform="translate3d(0,"+this.scrollTop+"px,0)";var e="translate3d("+this.scrollLeft+"px,0,0)";n.querySelector("th").style.transform=e,[].slice.call(i.querySelectorAll("tr > td:first-child")).forEach((function(t,n){t.style.transform=e}))})),{relayout:o}}$(document).ready((function(){var t=window.pageYOffset;function n(){$(window).width()<1200?($(".header__menu").hide(),$(".header__menu:hidden")||$(".toggle-btn").hasClass("active"),$(".toggle-btn").hasClass("active")||$(".header__menu:visible"),$(".header__menu ul li a").click((function(){$(".header__menu").slideUp(200),$(".toggle-btn").removeClass("active")})),$(".toggle-btn").removeClass("active"),$("html").removeAttr("style")):$(".header__menu").show()}$(window).scroll((function(){var e=window.pageYOffset;e>50?(t>e?(document.getElementById("header").classList.remove("hide"),document.getElementById("header").classList.add("show")):(document.getElementById("header").classList.remove("show"),document.getElementById("header").classList.add("hide")),t=e):document.getElementById("header").classList.remove("show","hide")})),$(".toggle-btn").click((function(){$(this).toggleClass("active"),$(".header__menu").slideToggle(200)})),n(),$(window).resize(n),$(".stock__slider.make").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,nextArrow:'<butoon class="next"></button>',prevArrow:'<butoon class="prev"></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".partners-slider.make").slick({infinite:!0,slidesToShow:5,slidesToScroll:1,nextArrow:'<butoon class="next"></button>',prevArrow:'<butoon class="prev"></button>',responsive:[{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1}},{breakpoint:767,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:992,settings:{slidesToShow:4,slidesToScroll:1}}]});var i=!1;if($(window).width()<767&&!i&&document.getElementById("fixed-table-container_price")){i=!0;var o,r=document.querySelectorAll("#fixed-table-container_price");for(o=0;o<r.length;++o)r[o].querySelector("table").classList="",r[o].classList.add("fixed-table-container"),e(r[o])}function s(e,t,n){var i=document.querySelectorAll(e),o=i[0].parentNode;(i=Array.prototype.slice.call(i,0)).sort((function(e,i){switch(t){case"brand":case"type":var o=e.getAttribute("data-"+t),r=i.getAttribute("data-"+t);break;default:o=parseInt(e.getAttribute("data-"+t)),r=parseInt(i.getAttribute("data-"+t))}return o===r?0:""===o?1:""===r?-1:"down"==n?o<r?-1:o>r?1:0:o<r?1:o>r?-1:0})),o.innerHTML="";for(var r=0,s=i.length;r<s;r++)o.appendChild(i[r])}function a(e,t){"undefined"!=typeof yaCounter28702351&&yaCounter28702351.reachGoal(e),"undefined"!=typeof ga&&ga("send","pageview","/virtual/"+e),dataLayer.push({event:"VirtualPageView",virtualPageURL:"/virtual/"+e,virtualPageTitle:t})}$(".toggle-more a").click((function(e){e.preventDefault();var t=$(this);t.parent().next().hasClass("show")?(t.addClass("collapsed"),t.parent().next().removeClass("show"),t.parent().next().slideUp(350),t.parent().parent().parent().parent().children(".table-box.car-section").removeClass("show"),t.parent().parent().parent().parent().children(".table-box.car-section").slideUp(350)):("undefined"!=typeof yaCounter28702351&&yaCounter28702351.reachGoal("show_more_autoinfo"),t.removeClass("collapsed"),t.parent().next().toggleClass("show"),t.parent().next().slideToggle(350),t.parent().parent().parent().parent().children(".table-box.car-section").toggleClass("show"),t.parent().parent().parent().parent().children(".table-box.car-section").slideToggle(350))})),$(".Sort-Order a").click((function(e){e.preventDefault();var t=$(this),n=t.parent().data("sort"),i="localhost"==location.hostname?"arenda-mashin.html":"/arenda-mashin/";t.parent().hasClass("Sort-Order_select")?t.parent().toggleClass("Sort-Order_up"):($(".Sort-Order").each((function(){$(this).removeClass("Sort-Order_select"),$(this).removeClass("Sort-Order_up")})),t.parent().addClass("Sort-Order_select")),t.parent().hasClass("Sort-Order_up")?(s(".product",n,"up"),window.history.pushState({},document.title,i+"?sort="+n+"&order=up")):(s(".product",n,"down"),window.history.pushState({},document.title,i+"?sort="+n+"&order=down"))})),function(){if(""!=window.location.hash)document.location.hash.substring(1);else window.location.search.substring(1);for(var e=window.location.search.substring(1).split("&"),t=[],n=["brand","type","price","rank"],i=["up","down"],o=0;o<e.length;o++){var r=e[o].split("=");"sort"===r[0]&&-1!=n.indexOf(r[1])&&t.push(r[1]),"order"===r[0]&&-1!=i.indexOf(r[1])&&t.push(r[1])}2==t.length&&s(".product",t[0],t[1]),window.location.pathname.split("/")}(),-1!=window.location.host.indexOf("avtobum63.ru")&&$("select.city").change((function(){$(this).find("option:selected").each((function(){var e="//";"smr"==$(this).attr("value")&&(e+="avtobum63.ru"),"cheb"==$(this).attr("value")&&(e+="cheboksary.avtobum63.ru"),"ufa"==$(this).attr("value")&&(e+="ufa.avtobum63.ru"),e+=window.location.pathname,location.href=e}))})),0!=$('[data-fancybox="group"]').length&&$('[data-fancybox="group"]').fancybox({buttons:["close"]}),0!=$('[data-src="#callback-form"]').length&&$('[data-src="#callback-form"]').fancybox({afterShow:function(e,t){var n=document.querySelector("#callback-form");n.querySelector("#frmwrapper").append(n.querySelector(".fancybox-close-small"))}}),0!=$(".embed-responsive.video").length&&$(".embed-responsive.video").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}}),$(".callback, .call, .question, .bron").click((function(e){})),$(".callback, .call, .question, .bron").click((function(){var e=$(this).attr("data-name"),t=$(this).attr("data-class");$("#btnname").val(e),$("#callback-form form").attr("data-class",t)})),$(".call").click((function(){a("zvonok_click","click callback btn")})),$(".bron").click((function(){a("reserv_click","click reserv btn")})),$(".question").click((function(){a("vopros_click","click vopros btn")})),$("#callback-form #inputPhone").focusout((function(){if($(this).val().length>=5)switch($("#callback-form form").attr("data-class")){case"call":a("zvonok_nabor","write smth callback phone");break;case"bron":a("reserv_dannih","write smth reserv phone");break;case"question":a("vopros_nabor","write smth vopros phone")}})),$("#callback-form form").submit((function(){switch($(this).attr("data-class")){case"call":a("zvonok_good","send callback info");break;case"bron":a("reserv_good","send reserv info");break;case"question":a("vopros_good","send vopros info")}})),$(document).on("submit","#frmwrapper form",(function(e){var t=$("#frmwrapper form");$("#frmwrapper form #submit").prop("disabled",!0),$.ajax({url:"/form_callme",type:"post",data:t.serialize(),success:function(e){$("#frmwrapper form").remove(),$("#frmwrapper").html(e)},error:function(e){console.log(e)}}),e.preventDefault()})),lazyload()}));var t=$(".main-slider"),n=t.find(".embed-player"),i=t.find(".slide-image"),o=0;function r(e,t){null!=e&&null!=t&&e.contentWindow.postMessage(JSON.stringify(t),"*")}function s(e,t){var n,i,o,s,a;if(i=(n=e.find(".slick-current")).attr("class").split(" ")[1],s=n.find("iframe").get(0),o=n.data("video-start"),"vimeo"===i)switch(t){case"play":null!=o&&o>0&&!n.hasClass("started")&&(n.addClass("started"),r(s,{method:"setCurrentTime",value:o})),r(s,{method:"play",value:1});break;case"pause":r(s,{method:"pause",value:1})}else if("youtube"===i)switch(t){case"play":r(s,{event:"command",func:"mute"}),r(s,{event:"command",func:"playVideo"});break;case"pause":r(s,{event:"command",func:"pauseVideo"})}else"video"===i&&null!=(a=n.children("video").get(0))&&("play"===t?a.play():a.pause())}function a(e,t){if(e[0]){var n,i,o=$(".main-slider"),r=o.width(),s=o.height();t=t||16/9;e.each((function(){var e=$(this);r/t<s?(n=Math.ceil(s*t),e.width(n).height(s).css({left:(r-n)/2,top:0})):(i=Math.ceil(r/t),e.width(r).height(i).css({left:0,top:(s-i)/2}))}))}}$((function(){t.on("init",(function(e){e=$(e.currentTarget),setTimeout((function(){s(e,"play")}),1e3),a(n,16/9)})),t.on("beforeChange",(function(e,t){s(t=$(t.$slider),"pause")})),t.on("afterChange",(function(e,t){s(t=$(t.$slider),"play")})),t.on("lazyLoaded",(function(e,t,n,r){++o===i.length&&i.addClass("show")})),t.slick({autoplaySpeed:4e3,lazyLoad:"progressive",speed:600,arrows:!1,dots:!0,cssEase:"cubic-bezier(0.87, 0.03, 0.41, 0.9)"})})),$(window).on("resize.slickVideoPlayer",(function(){a(n,16/9)}))}),jQuery);